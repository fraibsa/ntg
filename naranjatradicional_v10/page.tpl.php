...
<div class="art-logo">
     <?php   if (!empty($site_name)) { echo '<h2 class="art-logo-name"><a href="'.check_url($front_page).'" title = "'.$site_name.'">'.$site_name.'</a></h2>'; } ?>
     <?php   if (!empty($site_slogan)) { echo '<h3 class="art-logo-text">'.$site_slogan.'</h3>'; } ?>
</div>
    ...
    <div class="art-footer-body">
                <div class="art-footer-text">
                    ...
                    if (!empty($footer) && (trim($footer) != '')) {
                        ...
                        ob_start(); ?>
<p><a href="/politicaprecios">Política precios y envíos</a> | <a href="/terminosuso">Terminos de uso</a> | <a href="/privacidad">Declaración de privacidad</a></p>
...
<div class="cleared"></div>
<p class="art-page-footer">Developed by <a href="https://plus.google.com/117239961547764939625?rel=author">Fco José Ibáñez Sabater</a></p>
