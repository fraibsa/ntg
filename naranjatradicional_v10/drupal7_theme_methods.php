...
function naranjatradicional_v10_process_html(&$variables) {
...
function naranjatradicional_v10_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function naranjatradicional_v10_button($variables) {
 ...
 */
function naranjatradicional_v10_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function naranjatradicional_v10_menu_local_task($variables) {
 ...
 */
function naranjatradicional_v10_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function naranjatradicional_v10_node_preview($variables) {
  $node = $variables['node'];
