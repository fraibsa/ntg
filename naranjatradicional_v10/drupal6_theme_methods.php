...
function naranjatradicional_v10_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function naranjatradicional_v10_feed_icon($url, $title) {
 ...
 */
function naranjatradicional_v10_preprocess_comment_wrapper(&$vars) {
 ...
 */
function naranjatradicional_v10_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb art-postcontent">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function naranjatradicional_v10_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function naranjatradicional_v10_button($element) {
...
*/
function naranjatradicional_v10_img_assist_page($content, $attributes = NULL) {
 ...
 * @ingroup themeable
 */
function naranjatradicional_v10_node_preview($node) {
