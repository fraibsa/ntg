...
function naranjatradicional_v10_regions() {
  return array(
 ...
 * @ingroup themeable
 */
function naranjatradicional_v10_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   The url of the feed.
 */
function naranjatradicional_v10_feed_icon($url) {
 ...
 */
function naranjatradicional_v10_comment_wrapper($content, $type = null) {
  static $node_type;
